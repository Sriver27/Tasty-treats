...
export const aboutContent = {
  ...
  description:
    "Tasty treats was founded with a simple mission: to make it easier for people to get their food delivered. With a food delivery app in India, they make it easy for people to order food from their favorite restaurants and have it delivered right to their door. They work with some of the best restaurants in the area, so people can always get the food they want, when they want it. Whether they're in the mood for Indian food, Italian food, or something else, Tasty treats has them covered. Plus, they offer great discounts on food delivery when people order through the app. With Tasty treats, there's no need to go out to eat; they can bring the restaurant to you.",
};
